...
class TurinV3FlatEnvCfg_PLAY(TurinV3FlatEnvCfg):
...
@configclass
class TurinV3FlatRefEnvCfg(TurinV3RoughRefEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        self.scene.terrain.terrain_type = "plane"
...
@configclass
class TurinV3FlatRefEnvCfg_PLAY(TurinV3FlatRefEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        self.scene.num_envs = 50
...
# @configclass
# class TurinV3FlatRefOrigRewardsEnvCfg(TurinV3RoughRefOrigRewardsEnvCfg):
#     def __post_init__(self):
#         # post init of parent
#         super().__post_init__()
