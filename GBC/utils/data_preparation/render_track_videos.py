...
if __name__ == "__main__":
    ...
    smplh_model_path = "~/sjtu/dataset/smplh/neutral/model.npz"
    dmpls_model_path = "~/sjtu/dataset/dmpls/neutral/model.npz"
    urdf_path = "~/sjtu/dataset/urdf_demo/urdf/demo.urdf"
    import os
    smplh_model_path = os.path.expanduser(smplh_model_path)
    dmpls_model_path = os.path.expanduser(dmpls_model_path)
    ...
    dataset_path='~/sjtu/dataset/amass'
    ...
    poseformer_model_path = "notebooks/exported/ik_model/models/09_05_08_epoch_990.pt"
    # poseformer_model_path = "./models/15_17_56_epoch_20.pt"
    # save_path = "/home/rl/sjtu/RobotCodespace/GBC/rendered_videos"
    save_path = "exported/rendered_videos"
    ...
    renderer = PoseRenderer(
        ...
        save_path=save_path,
        device=device,
        secondary_dir="ACCAD/Male2General_c3d"
    )
    renderer.main()
